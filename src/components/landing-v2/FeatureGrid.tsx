...
export const FeatureGrid = () => (
  <section className="py-20 lg:py-32">
    <div className="container mx-auto px-4">
      <h2 className="text-center text-4xl font-bold text-white tracking-tight">An Institutional-Grade Calculation Engine</h2>
      <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feature, i) => (
          <motion.div 
            key={feature.title}
            className="p-6 rounded-xl border border-glass-border bg-navy-light/40 transition-all duration-300 hover:bg-navy-light/80 hover:-translate-y-1"
